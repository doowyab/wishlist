...
const Home = () => {
    ...
    <div className="py-12">
        ...
        <div className="bg-gray-50 rounded-3xl p-10 mt-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-3">Friends & Family Shop</h3>
                    <p className="text-gray-600">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-3">Perfect Presents Arrive</h3>
                    <p className="text-gray-600">
