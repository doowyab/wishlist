        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="edit-details" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            className="w-5 h-5 text-pink-500 border-gray-300 dark:border-gray-600 rounded focus:ring-pink-500"
                        />
                        <label htmlFor="edit-is-multibuy" className="text-sm font-medium text-gray-700 dark:text-gray-300">
